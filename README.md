...
Here we'll outline the general steps that were ran to clean each individual data source. For more information, check out the respective src files for the cleaning processes.
